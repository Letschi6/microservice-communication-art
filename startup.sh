...
~/tools/kafka_2.12-2.1.1/bin/zookeeper-server-start.sh ~/tools/kafka_2.12-2.1.1/config/zookeeper.properties &
sleep 10
~/tools/kafka_2.12-2.1.1/bin/kafka-server-start.sh ~/tools/kafka_2.12-2.1.1/config/server.properties &
